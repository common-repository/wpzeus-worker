    ...
    {		
        ...
        if (!file_exists($file_path)) {
            if (!mkdir($file_path, 0755, true))
                return array(
                    'error' => 'Permission denied, make sure you have write permission to wp-content folder. Try to chmod the folder with SSH or FTP or contact your wordpress network admin'
                );
        }
